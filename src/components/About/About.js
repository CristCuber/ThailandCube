...
const speedCubing = {
  ...
  paragraph: [
    ...
    {detail: 'นอกจากนนี้การเล่น Speed Cubing ยังไม่ได้จำกัดอยู่แค่กับวัยเด็กเท่านั้น ผู้คนทุกวัยก็สามารถเล่นได้ โดยในวัยผู้ใหญ่นั้น การเล่น Speed Cubing มีผลในช่วยในการป้องกันโรคเกี่ยวกับความจำอย่างเช่นโรคอัลไซเมอร์ได่อีกด้วย'},
  ]
}

const history = {
  title: 'ประวัติ ThailandCube',
  paragraph: [
